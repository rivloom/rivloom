...
截至 `origin/main` 的 `22db844b5c459dcb1415c45577013a3b171ff497`：
...
- Add: `rivloom-docs/plans/2026-08-30-runtime-host-collaboration-design.md`
- Add: `rivloom-docs/plans/2026-08-30-runtime-host-transition-plan.md`
- Add: `rivloom-docs/adr/0005-use-external-agent-runtimes.md`
- Add: `rivloom-docs/adr/0006-separate-rivloom-identity-from-runtime-auth.md`
- Modify: `rivloom-docs/README.md`
- Modify: `rivloom-docs/plans/2026-08-24-rivloom-desktop-architecture-design.md`
- Modify: `rivloom-docs/plans/2026-08-27-desktop-local-projects-and-threads-design.md`
- Modify: `rivloom-docs/plans/2026-08-27-desktop-local-projects-and-threads-verification.md`
- Modify: `rivloom-docs/adr/0001-use-tauri-react-and-app-server-sidecar.md`
- Modify: `rivloom-docs/adr/0002-isolate-rivloom-codex-home.md`
- Modify: `rivloom-docs/adr/0003-separate-rivloom-code-from-upstream-codex.md`
- Modify: `rivloom-docs/adr/0004-use-stable-cwd-for-local-projects.md`

**Steps:**

1. 将 2026-08-30 设计标为当前权威设计。
2. 将 2026-08-24 设计标为历史基线，列出保留和被取代的章节。
3. 在 A2 设计与验证顶部说明旧“下一步 A3”已被新路线取代。
4. 更新文档索引和 ADR 交叉引用。
5. 运行链接、空白和差异校验。
...
```powershell
git diff --check
rg -n "当前权威设计|Runtime Host|ADR-0005|ADR-0006" rivloom-docs
git diff --stat
...
git commit -m "docs: reframe Rivloom around external runtimes"
```
...
- PR #37, branch `codex/a3-chat-design`
- PR #38, branch `codex/a3-bounded-history`

**Steps:**

1. 保留两个分支和本地 worktree，不删除历史成果。
2. 将两个 PR 标记为 Draft。
3. 各留言一次：已接受 Runtime Host/多人协作路线，PR 暂停且不再是后续前置；链接新文档 PR。
4. 不合并、不关闭，直到未来明确决定复用或废弃。
